...
import { podeGerirSons } from './cargos.mjs';
...
export function adicionarSom(db, servidorId, quem, { nome, arquivo }) {
  if (!podeGerirSons(quem)) throw new ErroDeConta('Só moderadores e o dono sobem sons.', 403);
...
export function removerSom(db, servidorId, quem, id) {
  if (!podeGerirSons(quem)) throw new ErroDeConta('Só moderadores e o dono apagam sons.', 403);
